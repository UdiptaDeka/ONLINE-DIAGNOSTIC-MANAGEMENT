...
<!--============= start main area -->
<body style="background-image: url('images/udi.jpg');background-size: 1360px 780px;background-repeat: no-repeat; background-position: top;background-attachment: fixed;">
