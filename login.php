...
<body style="background-image: url('images/k10.jpg');background-size: 1360px 780px;background-repeat: no-repeat; background-position: top;background-attachment: fixed;">
	<div id="back-to-home">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
				...
				<span style="color: blue"><i class="fa fa-gg"></i></span>
				<span style="color: black">ODLMS</span>
