...
<body>
	<div class="header" id="home">
		<div class="header-top">
			<div class="container">
			   <div class="logo">
				  <a href="index.php">ONLINE DIAGNOSTIC LAB <span>INFORMATION</span></a>
				</div>
				<div class="top-menu">
					<span class="menu"><img src="images/to-top2.png" alt=""/> </span>
						<ul>
...
<!--//gallery-->
	...
	<div class="footer-section">
						...
						<p style="font-size: 20px" "color: black">Online Diagnostic Lab Information System @ 2020</p>
									</div>
							<script type="text/javascript">
				...
				<a href="#" id="toTop" style="display: block;"> <span id="toTopHover" style="opacity: ;"> </span></a>
				</div>
			</div>
</body>
</html>