...
<body class="menubar-left menubar-unfold menubar-light theme-primary">
  <body style="background-image: url('images/98.jpg');background-size: 1360px 780px;background-repeat: no-repeat; background-position: top;background-attachment: fixed;">
<!--============= start main area -->
